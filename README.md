...
*   Tahun 2020: *Overall Accuracy* (OA) mencapai 81,4% dengan nilai *Cohen's Kappa* 0,76 dengan kategori kelas.
...
*   `data/` : (Lokal) Tempat menyimpan *Shapefile* batas administrasi dan sungai pendukung. File raster mentah Sentinel-2 termasuk di dalamnya.
*   `output/` : Tabel akurasi hasil (*Overall Accuracy, Kappa, Producer/User Accuracy*) dalam format CSV.
